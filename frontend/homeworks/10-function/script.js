...
//? 9-Finding the exact divisors of a number
...
//? 10-Calculating exponential numbers=>Davetsiz misafir fonksiyonu ile çözüldü
...
//? 11-Calculating the factorial of the number
...
//? 12-How to find out if the number has a digit
...
//? 13-Finding Four-digit palindrome numbers
...
const isPalindrome = (n) => {
    let numberToString = "";
    let lenghtN = n.toString().length;

    for (let i = lenghtN - 1; i >= 0; i--) {
        numberToString += n.toString()[i];
        if (n == numberToString) {
